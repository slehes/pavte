...
struct ChatDetailView: View {
    ...
    private func stopVoiceRecording() {
        ...
        // Create a simple audio placeholder data
    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: isOutgoing ? .trailing : .leading, spacing: 4) {
                ...
                // Text content (show if no media, or as caption)
...
// MARK: - Real Media Preview (with actual data)
...
// MARK: - Placeholder Media Preview (fallback)
